...
//    private String env;
    ...
    /**
     * 定义拦截规则：拦截*.web.controller包下面的所有类中，有@RequestMapping注解的方法。
     */
    //@Pointcut("execution(* *.web.controller..*(..)) and @annotation(org.springframework.web.bind.annotation.RequestMapping)")
    @Pointcut("execution(* *.rest.webmvc.RepositorySearchController..*(..)) ")
